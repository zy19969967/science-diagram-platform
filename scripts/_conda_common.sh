...
load_platform_env() {
  ...
  export FLUX_MODEL_REPO="${FLUX_MODEL_REPO:-black-forest-labs/FLUX.1-schnell}"
  export FLUX_MODEL_DTYPE="${FLUX_MODEL_DTYPE:-bfloat16}"
  export FLUX_NUM_INFERENCE_STEPS="${FLUX_NUM_INFERENCE_STEPS:-4}"
  export FLUX_GUIDANCE_SCALE="${FLUX_GUIDANCE_SCALE:-0.0}"
  export FLUX_MAX_SEQUENCE_LENGTH="${FLUX_MAX_SEQUENCE_LENGTH:-256}"
