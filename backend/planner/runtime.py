...
class PlannerRuntime:
    ...
    def _messages(self, prompt: str, include_image: bool) -> list[dict[str, Any]]:
        system_text = (
            ...
            "CRITICAL RULE: If the user wants to delete, remove, erase, clean, or get rid of ANY object "
            "(including words like 删除, 去掉, 移除, 去除, 抹掉, erase, delete, remove), "
            "you MUST set task='object-removal' and task_prompt=''. "
            "Object removal uses NO positive prompt — PowerPaint auto-fills the masked area with surrounding background. "
            "For removal negative_prompt, use: 'text, letters, words, watermark, blurry, artifacts, object remnants'. "
